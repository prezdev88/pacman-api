...
public class NativeUpgradedPackageLogController {
    ...
    public ResponseEntity<Object> getUpgradedPackages(@ModelAttribute GetUpgradedPackagesRequest getUpgradedPackagesRequest) {
        ...
        return ResponseEntity.ok().body(upgradedPackages);
    }
